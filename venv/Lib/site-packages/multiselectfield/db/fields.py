...
def __init__(self, *args, **kwargs):
        ...
        # Ensure that validators is a list before attempting to access its elements
    if not hasattr(self, 'validators'):
        self.validators = []
        
        # Set the first validator in the validators list to MaxValueMultiFieldValidator
